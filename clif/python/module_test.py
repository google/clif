...
class ModuleTest(unittest.TestCase):
  ...
  def testFuncInit(self):
    ...
    if self.m.py3output:
      ...
      self.assertMultiLineEqual(out, textwrap.dedent(r"""
        PyObject* Init() {
          PyObject* module = Py_InitModule3(ThisModuleName, MethodsStaticAlloc, "CLIF-generated module for my.h");
          if (!module) return nullptr;
          return module;
        }"""))
  ...
  def testModConst(self):
    ...
    self.assertMultiLineEqual(out, textwrap.dedent("""
        ...
        PyObject* Init() {
          PyObject* module = Py_InitModule3(ThisModuleName, nullptr, "CLIF-generated module for my.h");
          if (!module) return nullptr;
          if (something_wrong) goto err;
          if (PyModule_AddObject(module, "ONE", Clif_PyObjFrom(static_cast<int>(kOne), {})) < 0) goto err;
          return module;
