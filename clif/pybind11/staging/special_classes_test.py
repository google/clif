...
"""Tests for clif.pybind11.staging.special_classes.

This file is a copy of clif/testing/python/special_classes_test.
"""

import unittest
from clif.pybind11.staging import special_classes
