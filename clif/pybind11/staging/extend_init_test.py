...
"""Tests for clif.pybind11.staging.extend_init.

This file is a copy of
clif/testing/python/extend_init.py.
"""

import unittest
from clif.pybind11.staging import extend_init
...
class ExtendInitTest(unittest.TestCase):
  ...
  @unittest.skip(
      'Pybind11 does not allow factory funtion to return nullptr.')
