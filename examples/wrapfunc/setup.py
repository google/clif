...
# This example (wrapfunc) requires that the wrappod example extension module is
# already installed.
import wrappod
...
setuptools.setup(
    name='pyclif_example_wrapfunc',
    version='1.0',
    description='Python CLIF wrapfunc example',
    ...
    ext_modules=[
        setuptools.Extension(
            ...
            library_dirs=['./'],
            libraries=['wrapfunc_cc_lib'],
            # The generated .so should be linked to the dependent "wrappod"
            # module.
            extra_objects=[wrappod.__file__],
            ),
        ],
    )
