...
setuptools.setup(
    name='pyclif_example_wrappod',
    version='1.0',
    description='Python CLIF wrappod example',
    ...
    # Another example "wrapfunc" depends on this extension module.
    # Hence, we make the generated header file available as a data file so that
    # wrapfunc can use it.
    data_files=[(user_home + '/opt/clif/examples/wrappod/python/',
                 ['python/wrappod.h'])],
    )
